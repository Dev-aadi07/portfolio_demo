...
const Contact = () => {
  ...
  const contactStyle =
    "cursor-pointer hover:text-zinc-300 transition duration-300";
      ...
      <div className="max-w-6xl mx-auto py-22 px-6">
        <div className="rounded-3xl p-12 bg-white/10 flex gap-16">
          ...
          >
            ...
            <motion.div
              className="mt-12 flex flex-col gap-5 text-zinc-400"
              initial="hidden"
              whileInView="visible"
              viewport={{ amount: 0.2 }}
              variants={{
            ...
            >
              ...
              >
                ...
                <h2 className={contactStyle}>hello@eliot.dev</h2>
              </motion.div>
              ...
              >
                ...
                <h2 className={contactStyle}>linkedin.com/in/eliot-dev</h2>
              </motion.div>
              ...
              >
                ...
                <h2 className={contactStyle}>github.com/eliot-dev</h2>
              </motion.div>
            </motion.div>
          </motion.div>
