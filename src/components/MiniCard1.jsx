...
const MiniCard1 = ({image, text1, date, headline, para}) => {
  return (
    <div className='flex flex-col rounded-2xl overflow-hidden bg-zinc-900 border border-zinc-700 hover:-translate-y-1 transition duration-300'>
      <div className='image-container h-44'>
        <img className='object-cover w-full h-full' src={image} alt="phote" />
      </div>
      <div className='details py-6 px-4 pb-10 flex flex-col gap-2'>

        <div className='flex gap-2'>
          <div className='px-3 py-1 text-xs flex items-center font-semibold rounded-2xl text-orange-500 bg-zinc-800 border border-zinc-700'>{text1}</div>
